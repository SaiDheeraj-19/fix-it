...
const AdminLogin: React.FC<AdminLoginProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-[url('/admin-bg.png')] bg-cover bg-center bg-fixed flex items-center justify-center p-4">
          ...
          <div className="relative">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="••••••••"
                className={`
                  w-full h-14 pl-12 pr-12 rounded-2xl border border-white/10 bg-black focus:ring-2 focus:ring-primary text-sm font-bold text-white transition-all
