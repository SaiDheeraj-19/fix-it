...
const StorePage: React.FC<StorePageProps> = ({
    ...
    const categories: (Category | 'All')[] = [
        'All', 'AirPods', 'Chargers', 'Cables', 'Skins', 'ScreenGuards', 'Speakers', 'Neckbands', 'WiredAudio', 'Accessory'
    ];
    ...
    return (
        <main className="max-w-4xl mx-auto px-4 pt-44 sm:pt-48">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-12 auto-rows-[160px] sm:auto-rows-[200px]">
                <div className="col-span-2 row-span-2 relative p-8 sm:p-10 rounded-[40px] overflow-hidden bg-black/40 backdrop-blur-md border border-white/5 bento-shadow flex flex-col justify-end group">
                ...
                <button onClick={scrollToArrivals} className="col-span-1 row-span-1 bg-black/40 backdrop-blur-md border border-white/5 rounded-[40px] p-6 flex flex-col items-center justify-center text-center gap-2 transition-all hover:bg-black/60 hover:border-primary/30 group active:scale-95">
                ...
                <a href="https://www.google.com/maps/search/?api=1&query=Fix+It+Kurnool+Temple+Line+ITC+Circle" target="_blank" rel="noopener noreferrer" className="col-span-1 row-span-1 bg-black/40 backdrop-blur-md border border-white/5 rounded-[40px] p-6 flex flex-col items-center justify-center text-center gap-2 group hover:border-white/20 transition-all">
